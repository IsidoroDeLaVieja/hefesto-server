...
class MessageTest extends TestCase
{
    ...
    public function testDeleteHeaderWhenKeyDoesNotExist() : void
    {
        $this->assertNull($this->message->getHeader('non-existent'));
        $this->message->deleteHeader('non-existent');
        $this->assertNull($this->message->getHeader('non-existent'));
    }
    ...
    public function testDeleteQueryParamWhenKeyDoesNotExist() : void
    {
        $this->assertNull($this->message->getQueryParam('non-existent'));
        $this->message->deleteQueryParam('non-existent');
        $this->assertNull($this->message->getQueryParam('non-existent'));
    }
    ...
    public function testGetQueryParamsAsString() : void
    {
        ...
        $this->assertSame(
            '?CustomId1=customid1&CustomId2=customid2',
    ...
    public function testDeletePathParamWhenKeyDoesNotExist() : void
    {
        $this->assertNull($this->message->getPathParam('non-existent'));
        $this->message->deletePathParam('non-existent');
        $this->assertNull($this->message->getPathParam('non-existent'));
    }
    ...
    public function testSetBodyGetBody() : void
    {
        ...
        $this->assertSame(
            (string)strlen($this->message->getBody()),
    ...
    public function testGetBodyAsArrayWithEmptyBody() : void
    {
    ...
    public function testSetPathWithMultipleQuerySeparatorsThrowsException() : void
    {
        $this->expectException(\Exception::class);
        $this->message->setPath('/home/isidoro?a=1?b=2');
    }
    ...
    public function testSetVerbWithInvalidMethodThrowsException() : void
    {
        $this->expectException(\Exception::class);
